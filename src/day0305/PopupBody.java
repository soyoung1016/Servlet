...
public class PopupBody extends HttpServlet {
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		PrintWriter out = response.getWriter();
	      ...
	      //쿠키가 존재하고 오늘 날짜와 같다면 팝업을 띄우지 않는다.
	...
	/////////////////////////////////////////////////////////////////////////////
	      ...
	      out.println("<h2>정윤이의 철권세상에 오신걸 환영합니다.</h2><br/>");
	      out.println("<img src='common/images/img.png' title='게임은 수업시간에 해야 제맛이쥬!'><br/>");
	      out.println("<h3>이번주 정보는 강남역 지하 게임 센터에서 화요일 19:00시부터 진행됩니다.</h3>");
	      out.println("<h3>많은 참여 부탁드려요~!!</h3>");
	      out.println("<img src='day0304/images/job.png'/><br/>");
