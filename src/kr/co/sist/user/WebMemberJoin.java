...
public class WebMemberJoin extends HttpServlet {
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		//사용자가 입력한 값(HTML Form Control) 받기 (get Parameter)
		...
		WebMemberVO wm_vo = new WebMemberVO(id, ShaUtil.shaEncoding(pass1), name,
			...
			age, marriageFlag, m_year+"-"+m_month+"-"+m_day, zipcode, addr1, addr2,
			greeting, request.getRemoteAddr(), interestlang);
	      ...
	      out.write("\t</div>\r\n");
	    	  ...
	    	  out.println("서비스가 원활하지 못한 점 뎨둉 ㅎ.<br/>");
	    	  out.println("정상적인 서비스를 위해서 저희 임직원들은 최선을 다하고 있습니다.<br/>");
	    	  out.println("신속하게 복구하겠습니다. 사용 중 불편한 점은 010-1111-1111으로 연락 바랍니다.<br/>");
	      }//end catch
